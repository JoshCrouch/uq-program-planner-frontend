...
export class ComponentFactory {
  ...
  public static registerComponent(
    type: string,
    componentClass: typeof ProgramComponent,
  ): boolean {
   ...
   */
  public static async createComponentFromJSON(
    json: any,
  ): Promise<ProgramComponent> {
  ...
  public static createJSONFromComponent(
    ...
    if (!componentClass) {
      throw new Error(
        `Component type "${component.getType()}" is not registered.`,
      );
    }
