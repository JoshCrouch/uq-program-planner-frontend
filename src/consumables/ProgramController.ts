...
/*
    ...
    This _should_ leave the Program.vue (the component that will have this controller) pretty empty, most likely just with a <v-for> loop to display each ProgramComponent
