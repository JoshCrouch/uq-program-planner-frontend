...
export class ProgramController {
  ...
  public async loadProgramFromJSON(loadedProgram: JSONProgram): Promise<void> {
    this.program.value =
      await ProgramFactory.buildProgramFromLoaded(loadedProgram);
  }
  ...
  public toJSON(): JSONProgram {
    const programJSON: JSONProgram = ProgramFactory.buildJSONFromProgram(
      this.program.value as Program,
    );
