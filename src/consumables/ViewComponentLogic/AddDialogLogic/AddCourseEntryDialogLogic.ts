...
/* ----- View Imports ----- */
import AddSingular from "../../../components/ProgramBuiderVIews/AddDialogs/CourseEntries/AddSingular.vue";
import AddOption from "../../../components/ProgramBuiderVIews/AddDialogs/CourseEntries/AddOption.vue";

/* ----- Logic Imports ----- */
import { CourseEntry } from "../../ProgramClasses/CourseEntries/CourseEntry.ts";

export function useAddCourseEntryDialogLogic(
  ...
  async function onAdd(): Promise<void> {
    ...
    if (
      ...
      typeof activeComponentRef.value.getCourseEntry !== "function"
    ) {
      toast.add({
        severity: "error",
        summary: "Error",
