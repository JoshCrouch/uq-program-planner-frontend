...
import AddProgramElective from "../../../components/ProgramBuiderVIews/AddDialogs/ProgramComponents/AddProgramElective.vue";
import AddGeneralElective from "../../../components/ProgramBuiderVIews/AddDialogs/ProgramComponents/AddGeneralElective.vue";

/* ----- Logic Imports ----- */
import { ProgramComponent } from "../../ProgramClasses/ProgramComponents/ProgramComponent.ts";

export function useAddProgramComponentDialogLogic(
  ...
  function onAdd() {
    ...
    if (
      ...
      typeof activeComponentRef.value.getProgramComponent !== "function"
    ) {
      toast.add({
        severity: "error",
        summary: "Error",
    ...
    if (
      selectedProgramComponentType.value === "programElective" &&
      hasProgramElective()
    ) {
    ...
    if (
      selectedProgramComponentType.value === "generalElective" &&
      hasGeneralElective()
    ) {
      // If so, show an error message
      toast.add({
